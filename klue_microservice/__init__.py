...
class API(object):
    ...
    def __init__(self, app, host='localhost', port=80, debug=False, log_level=logging.DEBUG, formats=None, timeout=20, error_reporter=None, jwt_secret=None):
        ...
        set_jwt_defaults(secret=jwt_secret)
        set_level(log_level)
        if error_reporter:
